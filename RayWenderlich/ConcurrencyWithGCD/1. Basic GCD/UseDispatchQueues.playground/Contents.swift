...
let mySerialQueue = DispatchQueue(label: "com.evgeniirosliakov.serial")
...
let workerQueue = DispatchQueue(label: "com.evgeniirosliakov.concurrent", attributes: .concurrent)
